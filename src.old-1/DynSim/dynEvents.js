...
Translates PhSim Events into HTML DOM Events

**/

export var registerCanvasEvents = function() {
...
export var registerKeyEvents = function() {
...
export var deregisterKeyEvents = function() {
	window.removeEventListener("keydown",this.keydownBridgeWrapper);
}


// Sim Events Aliases [END]
