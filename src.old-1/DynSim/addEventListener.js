...
export var addEventListener = function(eventStr,call,options = {}) {
...
export var removeEventListener = function(eventStr,call) {
...
export var callEventClass = function(eventStr,thisArg,eventArg) {
